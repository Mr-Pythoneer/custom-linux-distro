...
Presentation
{
    ...
    Slide {
        centeredText: qsTr("AI mode: a local-first AI layer built around Crucible12 -- llama.cpp serving models on your own GPU through OpenCode, no API keys, no cloud, no telemetry by default.")
    }
